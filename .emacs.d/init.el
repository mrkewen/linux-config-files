(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (evil-leader evil-easymotion evil-avy jinja2-mode web-mode dashboard rainbow-delimiters ace-window projectile magit flycheck powerline company cider clojure-mode elixir-mode solarized-theme))))
(custom-set-faces
